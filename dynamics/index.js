...
function colocarPlanetas()
{
    ...
    indices=[indice];
    posXMarte= posX[indice];
    do
    {
        indice = Math.floor((Math.random()*100)%4);
        posXSaturno= posX[indice];
    ...
    {
        indice = Math.floor((Math.random()*100)%4);
        posXTierra= posX[indice];

    }while(indices.includes(indice));

    planetas =new Array (posXMarte, posXNeptuno, posXSaturno, posXTierra);
...
function fondoJuego()
{
    ...
    ctx.drawImage(marte, posXMarte,0,120,120);
    ctx.drawImage(saturno, posXSaturno,-20,260,170);
    ctx.drawImage(neptuno, posXNeptuno,0,120,120)
    ctx.drawImage(tierra, posXTierra,0,120,120);
}
window.addEventListener("load", ()=>{
...
document.addEventListener("keydown", (evento)=>{
    if(vidas>0 && pausa==0)
    {
        ...
        if(cohete1.dx<=posXMarte+60 && cohete1.dx>=posXMarte && cohete1.dy<=30 && cohete1.dy>=0)
        {
            elegido=cohete2;
        ...
        if(cohete2.dx<=posXNeptuno+70 && cohete2.dx>=posXNeptuno+10 && cohete2.dy<=20 && cohete2.dy>=0)
        {
            elegido=cohete3;
        ...
        if(cohete3.dx<=posXSaturno+115 && cohete3.dx>=posXSaturno+75 && cohete3.dy<=40 && cohete3.dy>=0)
        {
            elegido=cohete4;
        ...
        if(cohete4.dx<=posXTierra+70 && cohete4.dx>=posXTierra+10 && cohete4.dy<=40 && cohete4.dy>=0)
        {
            elegido=null;
            cohete4.dibujar();
            if(llegoNeptuno==0)
